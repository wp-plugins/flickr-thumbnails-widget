...
class FlickrThumbsWidget extends WP_Widget {
  ...
  function form($instance) {
    $defaults = array('title'=>'Flickr', 'searchtext'=>'', 'type'=>'group', 'numpics'=>10, 'numcols'=>1);
    ...
    <input type="radio" name="<?php echo $this->get_field_name('type'); ?>" value="group"<?php if($instance['type'] == 'group') {echo ' checked';} ?>>group</input>
		...
		<p><label for="<?php echo $this->get_field_id('numpics'); ?>">Number of images to show: <input style="width: 50px;" id="<?php echo $this->get_field_id('numpics'); ?>" name="<?php echo $this->get_field_name('numpics'); ?>" type="text" value="<?php echo $instance['numpics']; ?>" /></label></p>
		<p><label for="<?php echo $this->get_field_id('numcols'); ?>">Number of columns: <input style="width: 50px;" id="<?php echo $this->get_field_id('numcols'); ?>" name="<?php echo $this->get_field_name('numcols'); ?>" type="text" value="<?php echo $instance['numcols']; ?>" /></label></p>
